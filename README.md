...
- [Numbers](https://github.com/krashner/Projects#numbers)
- [Classic Algorithms](https://github.com/krashner/Projects#classic-algorithms)
- [Graph](https://github.com/krashner/Projects#graph)
- [Data Structures](https://github.com/krashner/Projects#data-structures)
- [Text](https://github.com/krashner/Projects#text)
- [Networking](https://github.com/krashner/Projects#networking)
- [Classes](https://github.com/krashner/Projects#classes)
- [Threading](https://github.com/krashner/Projects#threading)
- [Web](https://github.com/krashner/Projects#web)
- [Files](https://github.com/krashner/Projects#files)
- [Databases](https://github.com/krashner/Projects#databases)
- [Graphics and Multimedia](https://github.com/krashner/Projects#graphics-and-multimedia)
- [Security](https://github.com/krashner/Projects#security)

Numbers
---------

[**Find PI to the Nth Digit**](https://github.com/Krashner/Projects/blob/master/Solutions/FindPiToTheNthDigit.cpp) C++ - Enter a number and have the program generate PI up to that many decimal places. Keep a limit to how far the program will go.

[**Find e to the Nth Digit**](https://github.com/Krashner/Projects/blob/master/Solutions/FindEToTheNthDigit.cs) C# - Just like the previous problem, but with e instead of PI. Enter a number and have the program generate e up to that many decimal places. Keep a limit to how far the program will go.

[**Fibonacci Sequence**](https://github.com/Krashner/Projects/blob/master/Solutions/FibonacciSequence.cs) C# - Enter a number and have the program generate the Fibonacci sequence to that number or to the Nth number.
...
[**Factorial Finder**](https://github.com/Krashner/Projects/blob/master/Solutions/FactorialFinder.cpp) C++ - The Factorial of a positive integer, n, is defined as the product of the sequence n, n-1, n-2, ...1 and the factorial of zero, 0, is defined as being 1. Solve this using both loops and recursion.
...
[**Collatz Conjecture**](https://github.com/Krashner/Projects/blob/master/Solutions/CollatzConjecture.cs) C# - Start with a number *n > 1*. Find the number of steps it takes to reach one using the following process: If *n* is even, divide it by 2. If *n* is odd, multiply it by 3 and add 1.
...
[**Fizz Buzz**](https://github.com/Krashner/Projects/blob/master/Solutions/FizzBuzz.cs) C# - Write a program that prints the numbers from 1 to 100. But for multiples of three print “Fizz” instead of the number and for the multiples of five print “Buzz”. For numbers which are multiples of both three and five print “FizzBuzz”.

[**Reverse a String**](https://github.com/Krashner/Projects/blob/master/Solutions/ReverseAString) C++ - Enter a string and the program will reverse it and print it out.

**Pig Latin** - Pig Latin is a game of alterations played on the English language game. To create the Pig Latin form of an English word the initial consonant sound is transposed to the end of the word and an ay is affixed (Ex.: "banana" would yield anana-bay). Read Wikipedia for more information on rules.

**Count Vowels** - Enter a string and the program counts the number of vowels in the text. For added complexity have it report a sum of each vowel found.

[**Check if Palindrome**](https://github.com/Krashner/Projects/blob/master/Solutions/CheckIfPalindrome) C++ - Checks if the string entered by the user is a palindrome. That is that it reads the same forwards as backwards like “racecar”
...
[**Turtle Graphics**](https://github.com/Krashner/Projects/tree/master/Solutions/TurtleGraphics) C# - This is a common project where you create a floor of 20 x 20 squares. Using various commands you tell a turtle to draw a line on the floor. You have move forward, left or right, lift or drop pen etc. Do a search online for "Turtle Graphics" for more information. *Optional: Allow the program to read in the list of commands from a file.*
